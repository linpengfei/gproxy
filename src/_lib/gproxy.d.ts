...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_10847: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_10910: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_14020: (a: number, b: number, c: number) => void;
